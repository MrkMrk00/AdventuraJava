...
public class SeznamPrikazu {
    ...
    /**
     * Konstruktor<br>
     * Inicializuje třídní proměnnou mapaSPrikazy (vytváří novou instanci HashMap)
     */
    ...
    /**
     * Getter přímo na mapu s příkazy, určeno pro testy
     * @return nemodifikovatelnou mapu s příkazy
     */
    public Map<String, IPrikaz> getMapaSPrikazy() {
        return Collections.unmodifiableMap(this.mapaSPrikazy);
    }
}
